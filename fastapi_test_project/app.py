...
description = """
fastapi_test_project API helps you do awesome stuff. 🚀
"""

app = FastAPI(
    title="fastapi_test_project",
    description=description,
    version=read("VERSION"),
    terms_of_service="http://fastapi_test_project.com/terms/",
    contact={
        "name": "klaipher",
        "url": "http://fastapi_test_project.com/contact/",
        "email": "klaipher@fastapi_test_project.com",
    },
    license_info={
        "name": "The Unlicense",
