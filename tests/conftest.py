...
# WARNING: Ensure imports from `fastapi_test_project` comes after this line
from fastapi_test_project import app, settings, db  # noqa
from fastapi_test_project.cli import create_user, cli  # noqa
